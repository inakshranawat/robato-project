...
export default function ContactUs() {
  ...
  // Add smooth scrolling using CSS
  useEffect(() => {
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        ...
        <div className="text-center mb-16">
          <div className="mb-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-700 mt-2">
              Contact Us
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            ...
            {contactInfo.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className={`w-14 h-14 rounded-lg bg-slate-900 flex items-center justify-center mb-5 transform transition-transform duration-300 ${hoveredCard === index ? 'scale-110' : ''}`}>
                  ...
                  {item.link ? (
                    ...
                    <>
                      ...
                      {item.value2 && (
                        <p className="text-slate-900 font-medium mb-1">{item.value2}</p>
                      )}
                      {item.value3 && (
                        <p className="text-slate-900 font-medium mb-1">{item.value3}</p>
                      )}
                    </>
                  )}
