...
{/** icons in the flex - Responsive Grid */}
 ...
 {/**  BUTTONS - Responsive */}
    <div className="flex flex-col sm:flex-row items-center justify-center py-12 lg:py-20 gap-4 lg:gap-5 px-4">
      <button className="w-full sm:w-auto text-white px-6 py-3 bg-purple-950 hover:bg-gray-600 hover:text-black transition-colors">
        TRY FOR FREE
      </button>
      <button className="w-full sm:w-auto bg-transparent border text-purple-950 hover:bg-purple-950 hover:text-white px-6 py-3 transition-colors">
        BOOK A DEMO
      </button>
    </div>
...
<div className="py-16 lg:py-30 px-4 sm:px-8" style={{backgroundImage: `url(${bgimg})`}}>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-5 mb-10 lg:pl-20'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-5 mb-10 lg:pl-20'>
        <div onClick={() => setActiveImage(0)} className="cursor-pointer text-center lg:text-left">
          <img className='hover:scale-115 transition-all duration-500 mx-auto lg:mx-0' width={80} src={security_icon} alt="" />
