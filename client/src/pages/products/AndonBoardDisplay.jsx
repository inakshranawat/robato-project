    ...
    <>
      <div className="bg-gray-50">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center py-10 sm:py-12 lg:py-20 gap-4 sm:gap-5 px-4">
          <button className="w-full sm:w-auto text-white px-6 py-3 bg-purple-950 hover:bg-gray-600 hover:text-black transition-all text-sm sm:text-base">
            TRY FOR FREE
          </button>
          <button className="w-full sm:w-auto bg-transparent border text-purple-950 hover:bg-purple-950 hover:text-white px-6 py-3 transition-all text-sm sm:text-base">
            BOOK A DEMO
          </button>
        </div>
        ...
        <div className="py-10 sm:py-20 lg:py-30" style={{backgroundImage: `url(${bgimg})`}}>
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 px-4 sm:px-6 lg:px-20 mb-6 lg:mb-10'>
            {[
              { icon: downtime_icon, title: 'Gather PLC data', index: 0 },
              { icon: resolution_icon, title: 'Effortlessly link sensors', index: 1 },
              { icon: Connectivityimg, title: 'Instantly convert data', index: 2 }
            ].map((item, idx) => (
              <div key={idx} onClick={() => setActiveImage(item.index)} className="cursor-pointer text-center">
                <img className='hover:scale-110 transition-all duration-500 w-16 sm:w-20 lg:w-[100px] mx-auto' src={item.icon} alt={item.title} />
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 px-4 sm:px-6 lg:px-20 mb-6 lg:mb-10'>
            {[
              { icon: power_icon, title: 'Gather PLC data', index: 0 },
              { icon: operating_temperature_icon, title: 'Effortlessly link sensors', index: 1 },
              { icon: protection_icon, title: 'Instantly convert data', index: 2 }
            ].map((item, idx) => (
              <div key={idx} onClick={() => setActiveImage(item.index)} className="cursor-pointer text-center">
                <img className='hover:scale-110 transition-all duration-500 w-16 sm:w-20 lg:w-[100px] mx-auto' src={item.icon} alt={item.title} />
                <h2 className='text-sm sm:text-base lg:text-xl hover:text-purple-950 font-bold mt-2 text-[#444444]'>
