  ...
  return (
    <div className="overflow-x-hidden">
        <div className='flex flex-col lg:flex-row py-10 md:py-30 lg:py-50 px-4 lg:px-0'>
         ...
         <div className='flex flex-col sm:flex-row items-center justify-center pb-10 md:pb-20 gap-5 px-4'>
           <button onClick={()=> navigate('/contact-us')} className='w-full sm:w-auto hover:bg-gray-500 hover:text-black bg-purple-950 text-white px-6 py-3'>TRY FOR FREE</button>
           <button onClick={()=> setDemoOpen(true)} className='w-full sm:w-auto hover:bg-purple-950 hover:text-white bg-transparent text-purple-950 border px-6 py-3'>BOOK A DEMO</button>
         </div>
      ...
      <div className='flex flex-col md:flex-row justify-center pl-0 md:pl-10 lg:pl-20 gap-5 md:gap-5 lg:gap-5 mb-10 px-4 lg:px-0'>
        <motion.div 
         initial={{opacity:0 , x:-100}}
                whileInView={{opacity:1,x:0}}
                transition={{duration:1 }}
      ...
      <div className='flex flex-col sm:flex-row items-center justify-center mt-10 py-10 md:py-20 gap-5 px-4'>
        <motion.button
         initial={{opacity:0 , x:-100}}
                ...
                transition={{duration:1 }}
                viewport={{once:true}}
        onClick={()=> navigate('/contact-us')} className='w-full sm:w-auto px-6 py-3 bg-purple-950 text-white hover:bg-gray-600 hover:text-black'>GET A QUOTE</motion.button>
        <motion.button
         initial={{opacity:0 , x:100}}
                whileInView={{opacity:1,x:0}}
                transition={{duration:1}}
      ...
      <div className='flex flex-col lg:flex-row pl-0 md:pl-10 lg:pl-20 py-10 md:py-30 lg:py-50 px-4 lg:px-0'>
        ...
        <div className="w-full lg:w-auto">
          <h1 className='text-3xl md:text-5xl lg:text-6xl pl-0 md:pl-10 lg:pl-20 tracking-tighter text-[#444444] text-depth font-bold uppercase w-full md:w-[600px] lg:w-[800px]'>Envision the production process</h1>
          <p className='font-bold text-[#444444] pl-0 md:pl-10 lg:pl-20 mt-5 md:mt-10 text-xl md:text-2xl'>Streamline production monitoring through automation</p>
          <p className='pl-0 md:pl-10 lg:pl-20 text-base md:text-lg lg:text-xl mt-2 w-full md:w-[500px] lg:w-[700px]'>Enable operators to achieve production targets by providing real-time insights into performance and promptly identifying production challenges.</p>
          <p className='cursor-pointer text-indigo-950 pl-0 md:pl-10 lg:pl-20 text-xl md:text-2xl mt-2 hover:underline'>MachinoX Pro Cloud</p>
        </div>
      </div>
     ...
     <div style={{
      ...
      <div className='flex flex-col md:flex-row items-center justify-center pl-0 md:pl-5 lg:pl-10 gap-6 md:gap-8 lg:gap-10 mt-10 md:mt-20 py-10 md:py-20 px-4 lg:px-0'>
            <div>
   ...
   {/**Ready to connect  your  shop  floor */}
      ...
      >
          ...
          <div className='pl-4 md:pl-30 lg:pl-50 relative z-10 mt-[-30px] md:mt-[-50px]'>
          <button onClick={()=> navigate("/contact-us")} className='w-full sm:w-auto bg-white text-indigo-950 px-6 py-4 hover:bg-purple-950 hover:text-white'>TRY FOR FREE</button>
          </div>
          <p className='pl-4 md:pl-30 lg:pl-50 relative text-white mt-3 text-sm md:text-base'>Want to see MachinoX Pro in action first? <span className='underline cursor-pointer' onClick={()=> setDemoOpen(true) }>Book a Demo</span> </p>
       </div>
