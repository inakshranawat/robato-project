    ...
    <div className="max-w-full overflow-x-hidden">
      <div className="flex flex-col lg:flex-row py-12 lg:py-50 px-4 lg:px-0">
        <div className="w-full lg:w-auto">
          <motion.h1 className="text-4xl lg:pl-20 text-[#444444] text-depth font-bold uppercase w-full lg:w-[800px]"
      ...
      <div className="flex flex-col lg:flex-row justify-center gap-8 lg:gap-15 mb-10 px-4 lg:px-0">
        <motion.div
           initial={{opacity:0,x:-100}}
            whileInView={{opacity:1,x:0}}
            transition={{duration:1}}
      ...
      >
        <div className="w-full lg:w-auto mb-8 lg:mb-0">
          <h1 className="text-6xl tracking-tighter w-full lg:w-[500px] text-white font-extrabold uppercase py-8 lg:py-20">
      ...
      <div className="flex flex-col lg:flex-row py-12 lg:py-30 px-4 lg:px-0">
        <div className="w-full lg:w-auto mb-8 lg:mb-0">
          <h1 className="text-6xl lg:pl-20 tracking-tighter text-[#444444] text-depth font-bold uppercase w-full lg:w-[800px]">
            Ready-to-Use
          </h1>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-purple-800 flex items-center justify-center p-8">
        <div className="max-w-6xl w-full">
          ...
          <div className="text-center mb-8">
            <h1 className="text-5xl md:text-6xl lg:text-9xl font-black text-white leading-tighter">
      ...
      <div
        className="relative w-full py-16 sm:py-20 bg-center bg-cover"
      ...
      >
        ...
        {/* Text Section */}
        <div className="relative z-10 px-4 sm:px-8 lg:pl-40 py-16 sm:py-20 text-center sm:text-left">
          <motion.h1
            initial={{opacity:0,x:100}}
            whileInView={{opacity:1,x:0}}
            transition={{duration:1}}
            viewport={{once:true}}
          className="text-white tracking-tight text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold leading-tight">
            READY TO CONNECT
          </motion.h1>
          <motion.h1
             initial={{opacity:0,x:-100}}
            ...
            transition={{duration:1}}
            viewport={{once:true}}
          className="text-white font-bold mt-2 text-4xl sm:text-5xl md:text-6xl lg:text-8xl leading-tight">
            YOUR SHOP FLOOR
          </motion.h1>
        </div>

        {/* Button Section */}
        <div className="relative z-10 px-4 sm:px-8 lg:pl-40 mt-4 sm:mt-6">
          <button className="bg-white text-indigo-950 px-6 py-3 sm:py-4 hover:bg-purple-950 hover:text-white w-full sm:w-auto transition-all duration-300 rounded-md">
            TRY FOR FREE
          </button>
        </div>

        {/* Demo Text */}
        <p className="relative z-10 text-white mt-3 px-4 sm:px-8 lg:pl-40 text-sm sm:text-base">
