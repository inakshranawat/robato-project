    ...
    <>
      {demoOpen && (
        <div
          ...
          onClick={() => setDemoOpen(false)} // click outside to close
        >
          <div
            className="bg-white w-[95%] md:w-[90%] lg:w-[85%] rounded-xl shadow-2xl relative max-h-[90vh] overflow-y-auto"
