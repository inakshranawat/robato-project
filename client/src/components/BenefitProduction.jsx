...
import { Dashborardimg, DigitalCounterimg, downtimeimg, Oeeimg, Scalabilityimg } from "../assets/assets";
    ...
    <>
      ...
      <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-10 mx-6 lg:mx-20 text-center">
        {[
          ...
          { img: "https://iiot.robatosystems.com/hubfs/mm20_icon_R2_pm%20alerts-1.svg", title: "CUSTOMIZABLE ALERTS" },
          { img: "https://iiot.robatosystems.com/hubfs/machine-conditions-in-real-time.svg", title: "Historical Analysis" },
          { img: "https://iiot.robatosystems.com/hubfs/mm20_icon_R2_home%20connect%20any%20mach.svg", title: "User Role Management" },
          { img: "https://iiot.robatosystems.com/hubfs/mm20_icon_R2_predict%20machine%20problems.svg", title: "Integration Capabilities" },
      ...
      <div className="flex flex-col  sm:flex-row mt-20 mb-20 items-center justify-center gap-6">
        <button onClick={()=> navigate('/contact-us') } className="px-6 py-4 bg-purple-950 text-white hover:bg-gray-500 hover:text-black rounded-lg transition-colors duration-300">
          TRY FOR FREE
        </button>
        <button onClick={()=> setDemoOpen(true)} className="px-6 py-4 bg-transparent border border-purple-950 rounded-lg hover:bg-purple-950 hover:text-white transition-colors duration-300">
          BOOK A DEMO
        </button>
      </div>
    </>
